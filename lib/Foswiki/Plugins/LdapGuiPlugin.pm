...
#
our $RELEASE = '24 May 2013';

# One line description of the module
our $SHORTDESCRIPTION =
  'An interface which enables to build a form based LDAP GUI over Foswiki.';
...
sub initPlugin {
    ...
    # like this:
    # $Foswiki::cfg{Plugins}{LdapGuiPlugin}{ExampleSetting} = 1;
    ...
    # LocalSite.cfg.
    # my $setting = $Foswiki::cfg{Plugins}{LdapGuiPlugin}{ExampleSetting} || 0;
